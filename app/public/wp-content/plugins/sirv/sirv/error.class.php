...
class FetchError{
    ...
    protected static $_errors_desc = array(
        1 => "check if file exists at expected URL and has right to be read.",
        2 => 'either upload the image manually to <a href="https://my.sirv.com/#/browse/" target="_blank">your Sirv account</a>; or replace it with a smaller image; or <a href="https://sirv.com/contact/" target="_blank">request</a> a higher limit; or upgrade to a <a href="https://sirv.com/help/resources/fetch-images/#File_size_limit" target="_blank">higher limit</a>.',
        3 => "clear the failed images and try again. Contact your hosting provider if this continues.",
        4 => 'clear the failed images and try again. <a href="https://sirv.com/contact/" target="_blank">Contact Sirv</a> if this error occurs again.',
        5 => '',
        6 => 'in mostly cases this error means that image to big for uploading'
