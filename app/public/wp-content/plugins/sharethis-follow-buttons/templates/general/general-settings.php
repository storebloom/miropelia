...
<div class="wrap sharethis-general-wrap">
	...
	<h4>
		...
		printf( esc_html__( 'Hi there, %1$s!', 'sharethis-follow-buttons' ), esc_html( $current_user->display_name ) );
		?>

		<?php
		// translators: Contact link.
		printf( esc_html__( 'Thanks for using ShareThis. If you have any questions please don\'t hesitate to %1$s contact our support %2$s We\'re here for you!', 'sharethis-follow-buttons' ), '<a class="st-contact" href="https://www.sharethis.com/contact?utm_source=sharethis-plugin&utm_medium=sharethis-plugin-page&utm_campaign=support" target="_blank">', '</a>' );
		?>
	</h4>
	...
	<table class="random-form-table">
		...
		<tr>
			<th scope="row">
				<?php esc_html_e( 'A random GIF', 'sharethis-follow-buttons' ); ?>

				<span>
					<?php esc_html_e( 'Honestly, this page was pretty boring, so we threw this in for good measure.  You\'re welcome.', 'sharethis-follow-buttons' ); ?>
				</span>
			</th>
			<td>
	...
	<table class="random-form-table">
		...
		<tr>
			<th scope="row">
				<span>
					<?php esc_html_e( 'Re-read our', 'sharethis-follow-buttons' ); ?>
					<a href="https://www.sharethis.com/privacy?utm_source=sharethis-plugin&utm_medium=sharethis-plugin-page&utm_campaign=Legal" target="_blank">
						<?php esc_html_e( 'Privacy Notice', 'sharethis-follow-buttons' ); ?></a>,
					<a href="https://www.sharethis.com/publisher-terms-of-use?utm_source=sharethis-plugin&utm_medium=sharethis-plugin-page&utm_campaign=Legal" target="_blank">
						<?php esc_html_e( 'Publisher Terms of User', 'sharethis-follow-buttons' ); ?></a>,
					<?php esc_html_e( 'and', 'sharethis-follow-buttons' ); ?>
					<a href="https://www.sharethis.com/publisher?utm_source=sharethis-plugin&utm_medium=sharethis-plugin-page&utm_campaign=Legal" target="_blank">
						<?php esc_html_e( 'Publisher Information', 'sharethis-follow-buttons' ); ?></a>
					<?php esc_html_e( 'pages.', 'sharethis-follow-buttons' ); ?>
				</span>
			</th>
		</tr>
		</tbody>
