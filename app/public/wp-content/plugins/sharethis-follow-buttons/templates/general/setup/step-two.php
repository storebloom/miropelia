...
<div id="sharethis-step-two-wrap">
	...
	<h4>
		<?php echo esc_html__( 'You\'re almost done! Create an account then configure your WordPress settings.', 'sharethis-follow-buttons' ); ?>
	</h4>
	...
	<div class="sharethis-account-creation">
		<div class="page-content" data-size="small" style="text-align: left;">
			...
			<div class="input " style="margin-bottom: 10px;">
				...
				<small><?php echo esc_html__( 'Password must be at least six characters.','sharethis-follow-buttons' ); ?></small>
			</div>
			...
			<a class="create-account st-rc-link" href="#">
				<?php esc_html_e( 'REGISTER & CONFIGURE', 'sharethis-follow-buttons' ); ?>
			</a>
		</div>
