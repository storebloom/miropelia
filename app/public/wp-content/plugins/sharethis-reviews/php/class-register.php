	...
	public function settings_api_init() {
		...
		foreach ( $this->setting_fields as $section => $settings ) {
			foreach ( $settings as $setting_field ) {
				register_setting( $this->menu_slug . '-general', $this->menu_slug . '_' . $setting_field['section'] . '_' . $setting_field['id_suffix'] );
				add_settings_field(
	...
	private function get_descriptions( $type = '', $subtype = '' ) {
		switch ( $type ) {
			case 'review':
				switch ( $subtype ) {
					case 'title':
						$description = esc_html__( 'Title for your reviews section:', 'sharethis-reviews' ) . '<span class="st-tooltip-icon"></span><div class="st-tooltip">' . $this->get_tooltip( $type, $subtype ) . '</div>';
						break;
					case 'approval':
						$description = esc_html__( 'Require administration approval before user review is published?', 'sharethis-reviews' );
						break;
					case 'account':
						$description = esc_html__( 'Require user account to leave reviews. No one without an account can leave reviews', 'sharethis-reviews' );
						break;
					case 'posttype':
						$description = esc_html__( 'Where can your users leave reviews on:', 'sharethis-reviews' ) . '<span class="st-tooltip-icon"></span><div class="st-tooltip">' . $this->get_tooltip( $type, $subtype ) . '</div>';
						break;
					case 'ctacopy':
						$description = esc_html__( 'The text in the button to leave a review:', 'sharethis-reviews' ) . '<span class="st-tooltip-icon"></span><div class="st-tooltip">' . $this->get_tooltip( $type, $subtype ) . '</div>';
						break;
					case 'ctacolor':
						$description = esc_html__( 'The color of the button to leave a review:', 'sharethis-reviews' ) . '<span class="st-tooltip-icon"></span><div class="st-tooltip">' . $this->get_tooltip( $type, $subtype ) . '</div>';
						break;
				}
				break;
			case 'rating':
				switch ( $subtype ) {
					case 'title':
						$description = esc_html__( 'Title for your rating section:', 'sharethis-reviews' ) . '<span class="st-tooltip-icon"></span><div class="st-tooltip">' . $this->get_tooltip( $type, $subtype ) . '</div>';
						break;
					case 'symbols':
						$description = '';
						break;
					case 'total':
						$description = esc_html__( 'Display the total rating sum above the rating section', 'sharethis-reviews' );
						break;
					case 'top':
						$description = esc_html__( 'Show highest ratings at the top.', 'sharethis-reviews' );
						break;
					case 'posttype':
						$description = esc_html__( 'Where can your users leave ratings on:', 'sharethis-reviews' ) . '<span class="st-tooltip-icon"></span><div class="st-tooltip">' . $this->get_tooltip( $type, $subtype ) . '</div>';
						break;
				}
				break;
			case 'impression':
				switch ( $subtype ) {
					case 'symbols':
						...
						break;
					case 'negative':
						$description = esc_html__( 'Don’t allow users to leave negative impressions', 'sharethis-reviews' );
						break;
					case 'posttype':
						$description = esc_html__( 'Where can your users leave impressions on:', 'sharethis-reviews' ) . '<span class="st-tooltip-icon"></span><div class="st-tooltip">' . $this->get_tooltip( $type, $subtype ) . '</div>';
						break;
				}
				break;
		} // End switch().
	...
	private function get_tooltip( $type = '', $subtype = '' ) {
		switch ( $type ) {
			case 'review':
				switch ( $subtype ) {
					case 'title':
						$description = esc_html__( 'Fill out this field to add a custom title to your reviews section.  You can leave this blank if you choose.', 'sharethis-reviews' );
						break;
					case 'posttype':
						$description = esc_html__( 'Any post type you check will display your reviews section.  If reviews and ratings share a selected post type they will combine into a review with a rating.', 'sharethis-reviews' );
						break;
					case 'ctacopy':
						$description = esc_html__( 'Defaults to "Add Review / Rating" if you have both active for the posttype.', 'sharethis-reviews' );
						break;
					case 'ctacolor':
			...
			case 'rating':
				switch ( $subtype ) {
					case 'title':
						$description = esc_html__( 'Fill out this field to add a custom title to your ratings section.  This will appear on post types you have selected with ratings alone.', 'sharethis-reviews' );
						break;
					case 'posttype':
						$description = esc_html__( 'Any post type you check will display your ratings section.  If ratings and reviews share a selected post type they will combine into a review with a rating.', 'sharethis-reviews' );
						break;
				}
				break;
			case 'impression':
				switch ( $subtype ) {
					case 'posttype':
						$description = esc_html__( 'Any post type you check will display your impression section.  If impressions shares a post type selection with the other two types it will show ABOVE the ratings/reviews section.', 'sharethis-reviews' );
						break;
				}
				break;
		} // End switch().
