...
<div class="review-management-wrap">
	...
	<div class="review-list">
		<?php
		if ( is_array( $this->current_reviews ) && array() !== $this->current_reviews ) :
					...
					<div class="review-item">
						...
						<?php if ( $this->review_approval && 'false' === $approved ) : ?>
							<div class="review-approval review-info">
								<button data-id="<?php echo esc_attr( $id ); ?>" data-pos="<?php echo esc_attr( $num ); ?>" class="approve-review">
									<?php echo esc_html__( 'Approve', 'sharethis-reviews' ); ?>
								</button>
							</div>
						<?php elseif ( 'false' !== $approved ) : ?>
							<div class="review-retract review-info">
								<button data-id="<?php echo esc_attr( $id ); ?>" data-pos="<?php echo esc_attr( $num ); ?>" class="retract-review">
									<?php echo esc_html__( 'Retract', 'sharethis-reviews' ); ?>
								</button>
							</div>
						<?php endif; ?>

						<button data-id="<?php echo esc_attr( $id ); ?>" data-pos="<?php echo esc_attr( $num ); ?>" class="remove-review">
