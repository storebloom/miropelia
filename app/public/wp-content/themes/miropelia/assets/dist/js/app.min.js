  ...
  1: [function (require, module, exports) {
    (function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
      ...
      function engageExploreGame() {
        ...
        document.getElementById('leave-map').style.opacity = '1'; // Bring touch buttons forward.
        ...
        const buttonShow = setInterval(function () {
          spinMiroLogo(touchButtons, touchButtons.className.split(' '), 'engage');
        }, 10000); // Add listeners for explore.
    ...
    }).call(this, require("fsovz6"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_e991a5a4.js", "/");
  }, {
    "buffer": 4,
    "fsovz6": 3
  }],
