  ...
  1: [function (require, module, exports) {
    (function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        document.querySelectorAll("#menu-main .menu-item-has-children").forEach(item => {
          item.addEventListener('click', function (event) {
            ...
            toggleMiroClass(menuItem, menuItemArr, 'engage'); // Click out of sub nav.
        ...
        setInterval(function () {
          ...
          spinMiroLogo(logo, logoArr, 'engage'); // Logo glow.
      ...
      function engageExploreGame() {
        ...
        const touchButtons = document.querySelector('.touch-buttons'); // Show leave map link.

        document.getElementById('leave-map').style.opacity = '1'; // Bring touch buttons forward and flash arrows.

        document.querySelector('.touch-buttons').style.zIndex = '99';
        spinMiroLogo(touchButtons, touchButtons.className.split(' '), 'engage'); // Run arrow flash intermittently.

        const buttonShow = setInterval(function () {
          spinMiroLogo(touchButtons, touchButtons.className.split(' '), 'engage');
        }, 10000); // Add listeners for explore keyboard movement.
        ...
        function miroExplorePosition(v, a, b) {
          ...
          const modalArr = modal.className.split(' '); // Overlap check for map item.
    ...
    }).call(this, require("fsovz6"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_cb571259.js", "/");
  }, {
    "buffer": 4,
    "fsovz6": 3
  }],
