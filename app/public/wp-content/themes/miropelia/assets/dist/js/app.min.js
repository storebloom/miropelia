(function e(t, n, r) {
  ...
  1: [function (require, module, exports) {
        ...
        if (miroElExists(explorePage)) {
          ...
          if (miroElExists(engageExplore)) {
            engageExplore.addEventListener('click', function () {
              ...
              document.querySelector('.touch-buttons').style.zIndex = '9';
            });
          ...
          forEach(mapItems, function (index, value) {
            ...
            const enterable = ['gillimank', 'caninth-village', 'wonderland', 'spinebeck']; // Add data point to button.
    ...
    }).call(this, require("fsovz6"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_b17e9dec.js", "/");
  }, {
    "buffer": 4,
    "fsovz6": 3
  }],
