  ...
  1: [function (require, module, exports) {
    (function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
        ...
        if (miroElExists(explorePage)) {
          ...
          forEach(characters, function (index, value) {
            value.addEventListener('click', function (e) {
              ...
              selectedCharacter.setAttribute('data-character', characterName); // Show all character bubbles.
      ...
      function engageExploreGame() {
        ...
        const touchButtons = document.querySelector('.touch-buttons'); // Show leave map link and keys guide.

        document.getElementById('leave-map').style.opacity = '1';
        document.getElementById('explore-points').style.opacity = '1'; // Flash key-guide.
        ...
        setInterval(function () {
          ...
          const topValInt = parseInt(topVal, 10); // Kill character if they hit these positions.
        ...
        function miroExplorePosition(v, a, b) {
          ...
          const character = box.getAttribute('data-character'); // Overlap check for map item.
    ...
    }).call(this, require("fsovz6"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_9d4e9cb4.js", "/");
  }, {
    "buffer": 4,
    "fsovz6": 3
  }],
